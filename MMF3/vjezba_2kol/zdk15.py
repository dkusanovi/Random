...
# jedan = eksplicitno(gx, poc_uvjeti1, 0.02)
# dva = eksplicitno(gx, poc_uvjeti2, 0.02)
# tri = eksplicitno(gx, poc_uvjeti3, 0.02)
# # cetiri = eksplicitno(gx, poc_uvjeti4, 0.02)
# # pet = eksplicitno(gx, poc_uvjeti5, 0.02)
...
jedann = implicitno(gx, poc_uvjeti1, 0.02)
dvaa = implicitno(gx, poc_uvjeti2, 0.02)
trii = implicitno(gx, poc_uvjeti3, 0.02)
# cetirii = implicitno(gx, poc_uvjeti4, 0.02)
# pett = implicitno(gx, poc_uvjeti5, 0.02)
...
# plt.plot(xlista, pet)
plt.legend(['150e', '300e', '450e', '150i', '300i', '450i'])
